...
\textbf{Data availability.} The retained experimental records, manifests, integrity checks, code, manuscript source, and figure source supporting the findings are available at \url{https://github.com/Xtsummer523/ICGP-reproducibility} (Release v1.0.3). Code is released under the MIT License; retained data, documentation, manuscript source, and figure source files are released under CC BY 4.0.
